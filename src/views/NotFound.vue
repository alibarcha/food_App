<template>
  <section class="bg-white dark:bg-gray-900">
    <div
      class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-10"
    >
      <div class="wf-ull lg:w-1/2">
        ...
        <h1
          class="mt-3 text-2xl font-bold text-gray-800 dark:text-white md:text-3xl"
        >
          Page not found
        </h1>
      ...
      <div class="relative w-full mt-8 lg:w-1/2 object-cover lg:mt-0">
        <img
